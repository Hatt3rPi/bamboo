...
<?php
$page_title       = 'Resumen · Bamboo Seguros';
$page_active      = '';
$breadcrumb_main  = 'Resumen';
$breadcrumb_sub   = 'Búsqueda';
...
<div class="bb-page-header">
  <div>
    ...
    <div class="subtitle">Detalle consolidado de cliente, pólizas, propuestas, endosos y siniestros</div>
  </div>
</div>
  ...
  <div class="card-body">
        <nav>
            <div class="nav nav-tabs" id="nav-tab" role="tablist">
                <a class="nav-item nav-link active" id="clientes" data-toggle="tab" href="#nav-cliente" role="tab" aria-controls="nav-cliente" aria-selected="true" onclick="cambiacolor(this.id)">Cliente</a>
                <a class="nav-item nav-link" id="poliza" data-toggle="tab" href="#nav-poliza" role="tab" aria-controls="nav-poliza" aria-selected="false" onclick="cambiacolor(this.id)">Póliza</a>
...
$(document).ready(function() {
    ...
    var table = $('#listado_clientes').DataTable({
        ...
        "ajax": _lazyAjax("/bamboo/backend/clientes/busqueda_listado_clientes.php", "clientes"),
    ...
    var table_polizas = $('#listado_polizas').DataTable({
        "ajax": _lazyAjax("/bamboo/backend/polizas/busqueda_listado_polizas.php", "poliza"),
        "initComplete": function(settings, json) {
    ...
    var table_tareas = $('#listado_tareas').DataTable({
        ...
        "ajax": _lazyAjax("/bamboo/backend/actividades/busqueda_listado_tareas_completas.php", "tarea"),
        "initComplete": function(settings, json) {
    ...
    var table_tareas_recurrentes = $('#listado_tareas_recurrentes').DataTable({
        ...
        "ajax": _lazyAjax("/bamboo/backend/actividades/busqueda_listado_tareas_recurrentes.php", "tarea_rec"),
    ...
    var table_propuesta_poliza = $('#listado_propuesta_polizas').DataTable({
        "ajax": _lazyAjax("/bamboo/backend/propuesta_polizas/busqueda_listado_propuesta_polizas.php", "propuestas"),
    ...
    //inicio endosos
        ...
        "ajax": _lazyAjax("/bamboo/backend/endosos/busqueda_listado_endosos.php", "endosos"),
    ...
    // inicio propuesta_endosos
        ...
        "ajax": _lazyAjax("/bamboo/backend/endosos/busqueda_listado_propuesta_endoso.php", "propuestas_endosos"),
        "initComplete": function(settings, json) {
    ...
    var table_siniestros = $('#listado_siniestros_resumen').DataTable({
        "ajax": _lazyAjax("/bamboo/backend/siniestros/busqueda_listado_siniestros.php", "siniestros"),
        "initComplete": function(settings, json) {
...
function botones(id, accion, base) {
    ...
    switch (accion) {
        ...
        case "generar_documento": {
            $.redirect('/bamboo/documento_propuesta_poliza.php', {
                'numero_propuesta': id,
                'accion': accion
            }, 'post');
            break;
