...
function abrirModalResolver(id_pendiente) {
    ...
    if (id_siniestro) {
        $.ajax({
            url: '/bamboo/backend/siniestros/busqueda_bienes_siniestro.php',
    ...
    $('#modalResolverPendiente .modal-footer button[onclick^="guardarResolverPendiente"]').text(
...
function renderResolver_companiaEntrega(p) {
    ...
    $.getJSON('/bamboo/backend/siniestros/busqueda_liquidadores_compania.php',
...
function guardarResolverPendiente() {
    ...
    $.post('/bamboo/backend/siniestros/actualiza_pendiente.php', data, null, 'json')
        .done(function(resp) {
            if (resp && resp.ok) {
...
<div class="modal fade" id="modalResolverPendiente" tabindex="-1" role="dialog">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-dismiss="modal">Cancelar</button>
        <button type="button" class="btn btn-bamboo" onclick="guardarResolverPendiente()">Cerrar pendiente</button>
      </div>
    </div>
  </div>
</div>
