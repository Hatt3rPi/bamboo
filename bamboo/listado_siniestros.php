...
function format_siniestro(d) {
    ...
    var botones =
        ...
        '<button title="Ver bienes y documentación de este siniestro" type="button" onclick="window.location.href=\'/bamboo/seguimiento_bienes_afectados.php?id_siniestro=' + d.id_siniestro + '\'">📦</button>';
...
function botones(id, accion) {
    ...
    switch (accion) {
        case "editar_siniestro": {
            window.location.href = '/bamboo/creacion_siniestro.php?id_siniestro=' + encodeURIComponent(id);
            break;
        }
