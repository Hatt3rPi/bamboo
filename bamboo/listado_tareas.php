...
$page_title       = 'Tareas · Bamboo Seguros';
$page_active      = 'tareas';
$breadcrumb_main  = 'Listado de tareas';
...
<div class="bb-page-header">
  <div>
    <h1>Tareas</h1>
    <div class="subtitle">Tareas y compromisos asignados</div>
  </div>
  <div class="d-flex" style="gap:var(--space-2)">
    <a href="creacion_actividades.php" class="btn btn-bamboo">
      <i class="fas fa-plus mr-2"></i>Nueva tarea
    </a>
    <a href="listado_tareas_recurrentes.php" class="btn btn-secondary">
      <i class="fas fa-redo mr-2"></i>Recurrentes
    </a>
  </div>
</div>
