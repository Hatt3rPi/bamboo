...
FORMAT(b.prima_afecta+0.0, 2,'de_DE') as prima_afecta, 
FORMAT(b.prima_exenta+0.0, 2,'de_DE') as prima_exenta, 
FORMAT(b.prima_neta+0.0, 2,'de_DE') as prima_neta, 
FORMAT(b.prima_bruta_anual+0.0, 2,'de_DE') as prima_bruta_anual, 
