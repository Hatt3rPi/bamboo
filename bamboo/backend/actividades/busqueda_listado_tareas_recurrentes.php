...
require_once "/home/gestio10/public_html/backend/config.php";
  ...
  {$conta=$conta+1;
    ...
    if (!$tareas->relaciones=="0"){
        ...
        $result_relaciones=db_query($link, "SELECT base, id_relacion FROM tareas_relaciones where id_tarea_recurrente='".$tareas->id."';");
