...
require_once "/home/gestio10/public_html/backend/config.php";
    ...
    $resul_rel_pol = db_query($link,
        "SELECT tr.id_tarea, p.id as id_poliza, p.estado,
         ...
         WHERE tr.base = 'polizas'
           AND tr.id_tarea IN (SELECT id FROM tareas WHERE estado IN ('Cerrado','Eliminado'))
    ...
    $resul_tareas = db_query($link,
        "SELECT a.id, fecha_ingreso, fecha_completada, fecha_vencimiento, tarea, estado, prioridad, procedimiento,
         ...
         WHERE estado IN ('Cerrado','Eliminado')
         GROUP BY a.id, fecha_ingreso, fecha_completada, fecha_vencimiento, tarea, estado, prioridad, procedimiento");
    ...
    while ($tareas = db_fetch_object($resul_tareas)) {
        ...
        $fila = array_merge(array(
            ...
            "feccierre"      => $tareas->fecha_completada,
            "tarea"          => $tareas->tarea,
