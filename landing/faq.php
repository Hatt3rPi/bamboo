...
$faqs = [
  ...
  ['q' => '¿Qué seguros puedo contratar con Bamboo Seguros?', 'a' => 'Para personas y pymes: seguro de vehículo, vida, viaje, accidentes personales, incendio y sismo, responsabilidad civil, garantía, transporte, arriendo (hogar), APV, ingeniería y RC para administradores. Como corredora independiente, los cotizamos con las principales aseguradoras del mercado chileno.'],
  ['q' => '¿Quién paga la comisión del corredor de seguros?', 'a' => 'La comisión del corredor la paga la compañía aseguradora, no el cliente. Se calcula como un porcentaje de la prima de la póliza. Por eso el asegurado no le paga al corredor: usted solo paga la prima a la aseguradora.'],
  ...
  ['q' => '¿Cómo elegir el mejor corredor de seguros?', 'a' => 'Verifica que esté inscrito en el Registro de la CMF, que sea independiente (que compare varias aseguradoras), que no te cobre por su asesoría y que ofrezca acompañamiento en caso de siniestro. Pide referencias y confirma que te explique con claridad coberturas, deducibles y exclusiones antes de contratar.'],
