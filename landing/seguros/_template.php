...
$schema = [
  ...
  [
    ...
    'itemListElement' => [
      ...
      ['@type' => 'ListItem', 'position' => 2, 'name' => 'Seguros', 'item' => $SITE['url'] . '/#servicios'],
  ...
  <div class="container">
    <div class="svc-layout">
      ...
      <aside class="svc-aside reveal" data-d="1">
        ...
        <button type="button" class="btn btn--primary btn--block" data-cotizar data-slug="<?= e($s['slug']) ?>"><?= bb_icon('chat') ?> Cotizar gratis</button>
