                ...
                <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item dropdown"> <a class="nav-link dropdown-toggle" href="#" id="navbarDropdownSiniestros"
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdownSiniestros">
                            <a class="dropdown-item" href="/bambooQA/listado_siniestros.php">Listado de siniestros</a>
                            <a class="dropdown-item" href="/bambooQA/seguimiento_bienes_afectados.php">Seguimiento bienes afectados</a>
                            <a class="dropdown-item" href="/bambooQA/admin_catalogo_documentos.php">Administrar catálogo documentos</a>
                        </div>
                    </li>
