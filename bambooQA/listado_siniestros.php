...
function format_siniestro(d) {
    ...
    var botones =
        ...
        '<button title="Ver bienes y documentación de este siniestro" type="button" onclick="window.location.href=\'/bambooQA/seguimiento_bienes_afectados.php?id_siniestro=' + d.id_siniestro + '\'">📦</button>';
