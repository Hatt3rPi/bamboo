...
if ($_SERVER[ "REQUEST_METHOD" ] == "POST")
    ...
    switch ($_POST["accion"]){
        case 'crea_propuesta_endoso':
            ...
            db_query($link, "select trazabilidad('".$_SESSION["username"]."', 'Creación propuesta endoso', '".str_replace("'","**",$query)."','propuesta_endoso', '".$numero_propuesta_endoso."' , '".$_SERVER['PHP_SELF']."')");
        ...
        case 'actualiza_propuesta':
            ...
            db_query($link, $query);
            db_query($link, "select trazabilidad('".$_SESSION["username"]."', 'Modificación propuesta endoso', '".str_replace("'","**",$query)."','propuesta_endoso', '".$_POST["numero_endoso"]."' , '".$_SERVER['PHP_SELF']."')");
            $busqueda=$numero_propuesta_endoso;
            break;
        case 'crear_endoso':
        ...
        case 'rechazar_propuesta':
            ...
            $mensaje='Propuesta Endoso rechazada correctamente';
                ...
                db_query($link, $query);
                db_query($link, "select trazabilidad('".$_SESSION["username"]."', 'Rechaza propuesta endoso', '".str_replace("'","**",$query)."','propuesta_endoso','".$nro_propuesta."', '".$_SERVER['PHP_SELF']."')");
                break;
    }
