...
while ($row = db_fetch_object($res)) {
    $data[] = array(
        ...
        'liquidador_fecha_orden_reparacion' => $row->liquidador_fecha_orden_reparacion,
        'importacion_repuestos'             => ($row->importacion_repuestos === 't' || $row->importacion_repuestos === true || $row->importacion_repuestos === '1'),
        'importacion_repuestos_obs'         => $row->importacion_repuestos_obs,
        'cliente_fecha_ingreso_taller'      => $row->cliente_fecha_ingreso_taller,
        'cliente_fecha_firma_finiquito'     => $row->cliente_fecha_firma_finiquito,
        'taller_fecha_compromiso_entrega'   => $row->taller_fecha_compromiso_entrega,
        'liquidador_fecha_finiquito'        => $row->liquidador_fecha_finiquito,
