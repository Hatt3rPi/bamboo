...
<body>
    ...
    <div class="container">
        ...
        <div class="container">
            ...
            <button title="Descargar_excel_propuestas" type="button"  onclick="window.location.href='/bambooQA/backend/polizas/genera_excel_polizas.php'">Descargar Excel <i class="fas fa-file-excel"></i></button>
            </div>
