...
$(function() {
    tabla = $('#tabla_templates').DataTable({
        ajax: { url: '/bambooQA/backend/email/busqueda_templates.php' },
        columns: [
            { data: 'codigo' },
            { data: 'nombre' },
            { data: 'modulo' },
...
function abrirModalTemplate(id) {
    if (id) {
        $.getJSON('/bambooQA/backend/email/busqueda_templates.php', function(resp) {
...
function guardarTemplate() {
    ...
    $.post('/bambooQA/backend/email/guarda_template.php', {
        id: $('#tpl_id').val(),
        codigo: codigo,
        nombre: nombre,
...
function eliminarTemplate(id) {
    ...
    $.post('/bambooQA/backend/email/elimina_template.php', { id: id }, null, 'json')
     .done(function(resp) {
